...
import { KIND_ARTICULO, KIND_PEDIDO_FUSION, armarAceptacion, armarArticulo, armarPregunta, armarRespuesta, armarVotoArticulo, minarYFirmar, valorDeTag } from "@botella/protocolo";
